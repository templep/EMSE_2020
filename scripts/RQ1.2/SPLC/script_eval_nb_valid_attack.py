...
##adv attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/acc/*20.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/acc/*50.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/acc/*100.csv")
##random attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/acc/*20.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/acc/*50.csv")
filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/acc/*100.csv")
#print (filenames)
