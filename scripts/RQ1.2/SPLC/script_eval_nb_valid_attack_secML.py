...
#filenames=glob.glob("../../../results/MOTIV/RQ1.1/secML/acc/*_dmax_100.0*_linear*.csv")
#filenames=glob.glob("../../../results/MOTIV/RQ1.1/secML/acc/*_dmax_100.0*_Log*.csv")
filenames=glob.glob("../../../results/MOTIV/RQ1.1/secML/acc/*_dmax_10000.0*_linear*.csv")
#filenames=glob.glob("../../../results/MOTIV/RQ1.1/secML/acc/*_dmax_10000.0*_Log*.csv")
#print (filenames)
...
for f in filenames:
	...
	output=open("../../../results/MOTIV/RQ1.2/secML/"+output_f,"w")
