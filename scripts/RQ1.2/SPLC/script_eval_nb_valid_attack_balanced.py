...
##adv attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*20.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*50.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*100.csv")
##random attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*20.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*50.csv")
filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/balanced_*100.csv")
