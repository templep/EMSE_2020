...
#		#could be x[43] = 1 also
	...
	#save in file
	if y0 == 0:
		np.savetxt("../../../results/JHipster/RQ1.1/secML/non_acc/test_adv_attack_secML_dmax_"+str(dmax)+"_label_0_linear_repet_"+str(rep)+".csv",output_pt_attacks,delimiter=',')
		#np.savetxt("../../../results/JHipster/RQ1.1/secML/non_acc/test_adv_attack_secML_dmax_"+str(dmax)+"label_0_Log.csv",output_pt_attacks2,delimiter=',')
	else:
		np.savetxt("../../../results/JHipster/RQ1.1/secML/acc/test_adv_attack_secML_dmax_"+str(dmax)+"_label_1_linear_repet_"+str(rep)+".csv",output_pt_attacks,delimiter=',')
		#np.savetxt("../../../results/JHipster/RQ1.1/secML/acc/test_adv_attack_secML_dmax_"+str(dmax)+"label_1_Log.csv",output_pt_attacks2,delimiter=',')

	np.savetxt("../../../results/JHipster/RQ1.1/secML/check_valid/successful_secML_attacks_"+str(nb_attack)+"_pts_dmax_"+str(dmax)+"_label_"+str(y0.item())+"_repet_"+str(rep)+".csv",nb_successful_attack,delimiter=',')
