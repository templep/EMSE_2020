...
##adv attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/*_20_label_nonacc.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/*50_label_nonacc.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/adv_attack_norm/non_acc/*100_label_nonacc.csv")
##random attack
#filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/non_acc/*20_nonacc.csv")
#filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/non_acc/*50_nonacc.csv")
filenames=glob.glob("../../../results/MOTIV/config_pt/random_attack_norm/non_acc/*100_nonacc.csv")
#print (filenames)
