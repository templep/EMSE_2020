...
filename = "../../../data/MOTIV/model_classif.txt"
...
header = np.genfromtxt('../../../data/MOTIV/train_format_weka.csv',dtype=str,delimiter=',')
header = header[0]
...
subprocess.call(["java -cp ../../../weka/weka.jar weka.classifiers.trees.J48 -t ../../../data/MOTIV/train_format_weka.arff -T ../../../data/MOTIV/test_format_weka.arff -C 0.25 -M 2 -d ../../../weka/j48_model/j48.model -o > ../../../results/MOTIV/retrain/eval_stat.txt"],shell=True)

##save tree in order to extract constraints
##CHANGE WEKA PATH
subprocess.call(["java -cp ../../../weka/weka.jar weka.classifiers.trees.J48 -t ../../../data/MOTIV/train_format_weka.arff -T ../../../data/MOTIV/test_format_weka.arff -C 0.25 -M 2 -d ../../../weka/j48_model/j48.model -g > ../../weka/trees/init_tree.txt"],shell=True)
...
for stp in step:
    ...
    for it in range(0,10):
        ...
        clf.fit(data,value)
        filename = "../../../results/MOTIV/retrain/model_classif_after_retrain_epoch_"+str(nb_epochs)+"_with_step_"+str(stp)+"_final_norm.txt"
        ...
        df.to_csv("../../../results/MOTIV/retrain/csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.csv",header=header,index=False)
        ...
        subprocess.call(["java -cp ../../../weka/weka.jar weka.core.converters.CSVLoader ../../../results/MOTIV/retrain/csv/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.csv > ../../../results/MOTIV/retrain/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.arff"],shell=True)
        print("end convert csv to arff")

        fi = fileinput.input("../../../results/MOTIV/retrain/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.arff",inplace=True)
        for line in fi:
        ...
        print("begin eval")
        subprocess.call(["java -cp ../../../weka/weka.jar weka.classifiers.trees.J48 -t ../../../results/MOTIV/retrain/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.arff -T ../../../data/MOTIV/test_format_weka.arff -C 0.25 -M 2 -d ../../../weka/j48_model/j48.model -o > ../../../results/MOTIV/retrain/eval_stat_after_attack_1_epochs_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm.txt"],shell=True,timeout=900)

        print("begin tree")
        ##save tree in order to extract constraints
        subprocess.call(["java -cp ../../../weka/weka.jar weka.classifiers.trees.J48 -t ../../../results/MOTIV/retrain/arff/data_after_attack_1_epochs_"+str(max_disp)+"_iter_"+str(nb_init_pts)+"_pts_"+str(stp)+"_eps_"+str(it+1)+"_iter_norm.arff -T ../../../data/MOTIV/test_format_weka.arff -C 0.25 -M 2 -d ../../../weka/j48_model/j48.model -g > ../../../weka/j48_model/trees/tree_after_attack_"+str(nb_init_pts)+"_pts_"+str(it+1)+"_disp_"+str(max_disp)+"_stp_"+str(stp)+"_norm.txt"],shell=True,timeout=900)
