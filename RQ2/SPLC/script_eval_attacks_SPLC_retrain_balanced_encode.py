...
header = np.genfromtxt('../../../data/MOTIV/augmented_train_data_after_preprocessing.csv',dtype=str,delimiter=',')
header = header[0]
...
data_full_train = np.loadtxt('../../../data/MOTIV/augmented_train_data_after_preprocessing.csv',delimiter=',',skiprows=1)
...
for stp in step:
    ...
    while nb_iter < max_iter:
        ...
        df.to_csv("../../../results/MOTIV/RQ2/SPLC/balanced/train_data_for_retraining_25_attack_pts_step_"+str(stp)+"_nb_displacement_"+str(max_disp)+"_iter_"+str(nb_iter)+".csv",header=header,index=False)
        ###RETRAINING
        ...
        f=open("../../../results/MOTIV/RQ2/SPLC/balanced/perf_predict_after_retraining_25_attack_pts_step_"+str(stp)+"_nb_displacement_"+str(max_disp)+"_iter_"+str(nb_iter)+".txt","w")
