    ...
    while nb_iter < max_iter:
        ...
        while nb_attack_pt < test_set_size:
            ...
            for pt in pts_to_move:
                ...
                data[nb_attack_pt] = pt
                value.put(nb_attack_pt,yc)

                nb_attack_pt += 1

#                np.savetxt("../../../results/JHipster/RQ1.1/SPLC/test.csv",data.round().astype(int),delimiter=',')
        ...
        if label == 0:
            np.savetxt("../../../results/JHipster/RQ1.1/SPLC/non_acc/test_adv_attack_"+str(stp)+"_nb_displacement_"+str(max_disp)+"_label_0.csv",np.array(data).round().astype(int),delimiter=',')
        else:
            np.savetxt("../../../results/JHipster/RQ1.1/SPLC/acc/test_adv_attack_"+str(stp)+"_nb_displacement_"+str(max_disp)+"_label_1.csv",np.array(data).round().astype(int),delimiter=',')
        nb_iter +=1
    ...
    if label == 0:
        ...
        f=open("../../../results/JHipster/RQ1.1/SPLC/check_valid/"+out_filename,"w")
    else:
